...
<% if (locals.service) { %>import { <%= h.changeCase.ucFirst(h.changeCase.camel(name)) %>Service } from './<%= h.changeCase.paramCase(name) %>.service';<% } %><% if (locals.pipe) { %>import { <%= h.changeCase.ucFirst(h.changeCase.camel(name)) %>Pipe } from './<%= h.changeCase.paramCase(name) %>.pipe';<% } %><% if (locals.directive) { %>import { <%= h.changeCase.ucFirst(h.changeCase.camel(name)) %>Directive } from './<%= h.changeCase.paramCase(name) %>.directive';<% } %>
